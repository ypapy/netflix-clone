                ...
                <div className="flex justify-center">
                    <div className="bg-black bg-opacity-70 px-16 py-16 self-center mt-2 lg:w-2/5 lg:max-w-md rounded-md w-full">
                        ...
                        <div className="flex flex-col gap-4">
                            <Input id="email" label="Email" onChange={(event: any) => setEmail(event.target.value)} type="email" value={email} />
                            {variant === 'register' && <Input id="name" label="Username" onChange={(event: any) => setUserName(event.target.value)} type="text" value={userName} />}
                            <Input id="password" label="Password" onChange={(event: any) => setPassword(event.target.value)} type="password" value={password} />
                        </div>
